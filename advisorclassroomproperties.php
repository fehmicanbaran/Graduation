                         ...
                         <div class="projects">
                             <div class="card">
                                 ...
                                 <div class="card-body">
                                    ...
                                    <a href="otherproperties.php"><input type='submit' name='submit' value='Click to Search' class='search' /></a>
                                    <br>
                                    <br>
                                            ...
                                            <?php
                                            $result = mysqli_query($conn,"SELECT * FROM classproperties INNER JOIN classroom ON classproperties.ClassroomId = classroom.ClassroomId WHERE FacultyId='".$_SESSION['userData'][5]."' ");
