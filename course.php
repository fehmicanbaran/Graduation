...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <body>
            <form action="include/createcourse.inc.php" method="post">
        ...
        <h4>
                    ...
                    <input class="form-select" type="text" id="CourseCode" name="CourseCode" required ></input>  <br>
                    <h4>
                        <p>Course Name</p>
                    </h4>
                    <br>
                    
                    <input class="form-select" type="text" id="CourseName" name="CourseName" required ></input>
                       
                   
                 
                    <input class="setbutton" type="submit" name="submit" value="Create Course">
