...
-- Üretim Zamanı: 17 Oca 2022, 23:42:20
...
CREATE TABLE IF NOT EXISTS `coursetime` (
  ...
  KEY `ClassroomId` (`ClassroomId`),
  KEY `SemesterId` (`SemesterId`)
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_turkish_ci;
...
(1, 1, '09.00 A.M', '09.50 A.M', 1, 1, 'Monday', 1),
(28, 5, '09.00 A.M', '09.50 A.M', 3, 2, 'Monday', 1),
(31, 1, '09.00 A.M', '09.50 A.M', 1, 1, 'Monday', 1),
(32, 1, '09.00 A.M', '09.50 A.M', 1, 1, 'Monday', 1),
(33, 1, '09.00 A.M', '09.50 A.M', 1, 1, 'Monday', 1),
(44, 1, '09.00 A.M', '09.50 A.M', 1, 1, 'Monday', 1);
...
(47, '15', '1', 'Monday', '09.00 A.M', '09.50 A.M', '0', '1', '1', '4', '2'),
(48, '3', '1', 'Monday', '09.00 A.M', '09.50 A.M', '1', '5', '3', '2', '3');
...
INSERT INTO `notifications` (`notificationId`, `userId`, `descriptions`, `subjects`) VALUES
(2, 2, 'a', 'a'),
(3, 2, 'b', 'b'),
(4, 2, 'test', 'test'),
(7, 2, 'a', 'a');
